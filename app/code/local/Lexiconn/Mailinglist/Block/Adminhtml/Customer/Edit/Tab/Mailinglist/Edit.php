...
class Lexiconn_Mailinglist_Block_Adminhtml_Customer_Edit_Tab_Mailinglist_Edit
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        $this->_objectId = 'id';
        $this->_controller = 'mailinglist';
    ...
    public function getFormHtml()
    {
       // $html = parent::getFormHtml();
        ...
        //$html .= $this->getLayout()->createBlock('lexiconn_mailinglist/adminhtml_customer_edit_tab_mailinglist_edit')->toHtml();
       // return $html;
    }
