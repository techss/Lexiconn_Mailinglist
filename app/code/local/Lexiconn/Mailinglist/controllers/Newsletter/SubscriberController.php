...
require_once("Mage/Newsletter/controllers/Newsletter/SubscriberController.php");
 ...
 */
class Lexiconn_Mailinglist_Controllers_Newsletter_SubscriberController extends Mage_Core_Controller_Front_Action
{
    /**
